var loadingModule = (function ($, window, document) {
    ...
    var scripts = {
        ...
        "footer": [
            {
                "elementID": "#tvi24-footer-external-scripts",
                "scripts": [
                    {
                        "name": "Learning Tags",
                        "value": "<!-- Begin ContainR -->" +
                            "<script type='application/javascript'>!function(n,t,a,i){n.mpfContainr||(n.mpfContainr=function(){a.push(arguments)},mpfContainr.q=a,(i=t.createElement('script')).type='application/javascript',i.async=!0,i.src='//cdn.mookie1.com/containr.js',t.head.appendChild(i))}(window,document,[]);" +
                            "mpfContainr('V2_7907',{'host': 'pt-gmtdmp.mookie1.com', 'tagType': 'learn','src.rand': '[timestamp]', 'src.id' : 'TVI24' });" +
                            "</script>" +
                            "<noscript>" +
                            "<iframe src='//pt-gmtdmp.mookie1.com/t/v2?tagid=V2_7907&isNoScript&src.rand=[timestamp]&src.id=TVI24' height='0' width='0' style='display:none;visibility:hidden'></iframe>" +
                            "</noscript>" +
                            "<!-- End ContainR -->"
                    }
                    /*,
    ...
    var loadHeadScripts = function () {
        if (navigator.userAgent && navigator.userAgent.indexOf("bot") === -1 && navigator.userAgent.indexOf("Bot") === -1 && navigator.userAgent.indexOf("Google Page Speed Insights") === -1 && navigator.userAgent.indexOf("Chrome-Lighthouse") === -1 && navigator.userAgent.indexOf("Speed Insights") == -1) {
            loadScripts(scripts["head"]);
        }
    };

    var loadBodyScripts = function () {
        if (navigator.userAgent.indexOf("bot") === -1 && navigator.userAgent.indexOf("Bot") === -1 && navigator.userAgent.indexOf("Google Page Speed Insights") === -1 && navigator.userAgent.indexOf("Chrome-Lighthouse") === -1 && navigator.userAgent.indexOf("Speed Insights") == -1) {
